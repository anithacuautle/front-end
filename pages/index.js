          ...
          <div className={styles.nav_container}>
            <div className={styles.logo}>
              ...
              <h1 className={styles.point}>
                Cédula Profesional: 12490409 UAEMÉX
              </h1>
            </div>
        ...
        <section className={styles.hero_main}>
          <div class="hero_textos">
            <h1 className={styles.title}>
              ...
              <span className={styles.title_active}>
                Debe tener espeanza para su nutrición.
              </span>
            </h1>
            <p className={styles.copy}>
              La primera riqueza{" "}
              <span className={styles.copy_active}>es la salud.</span>
            </p>
        ...
        <section className={styles.services}>
          <div className={styles.container}>
            <h2 className={styles.subtitle}>
              Nuestros servicios<span className={styles.point}>.</span>
            </h2>
            <p className={styles.copy_section}>
              Ofrecemos nuestros servicios perfectos
            </p>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footer_copy}>
          <p className={styles.copyright}>
            L.N. Monserrat Piña Jímenez &copy; 2022 Todos los derechos
            reservados
          </p>
          <br></br>
          <a href="#" className={styles.pol_priva}>
